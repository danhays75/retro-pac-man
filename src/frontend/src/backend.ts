...
export class Backend implements backendInterface {
    ...
    async __highScore(): Promise<any> {
        if (this.processError) {
            try {
                const result = await this.actor.__highScore();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHighScoreRecord(): Promise<{
        score: bigint;
        updatedAt: bigint;
        playerName: string;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getHighScoreRecord();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitScore(arg0: bigint, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
